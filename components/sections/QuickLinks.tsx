...
const TILES = [
  {
    icon: "MoveRight",
    title: "Solutions",
    sub: "Six outcomes, each with a reference architecture",
    href: "/solutions",
  },
  {
    icon: "Layers",
    title: "Editions & pricing",
    sub: "Standard $24,000 · Enterprise $120,000 a year",
    href: "/pricing",
  },
  {
    icon: "ShieldCheck",
    title: "Trust Center",
    sub: "Five ISO certifications, signed PDFs to download",
    href: "/trust",
  },
  {
    icon: "LayoutTemplate",
    title: "Explore the platform",
    sub: "9 families · 14 modules · what each replaces",
    href: "/platform",
  },
];
