...
import { certificationSpec, docPageSpec, jobOpeningSpec, legalPageSpec, partnerTrackSpec } from "./docs/collections";
...
export const allDocSpecs: DocSpec[] = [...singletonSpecs, ...collectionSpecs];
